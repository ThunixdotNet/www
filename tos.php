					...
					<div id="content">
						<div class="post">
							...
							<div class="entry">
								...
								<li>Storing/distributing, promoting, or discussing pirated/cracked software, license keys, license/registration circumvention programs, or any questionable programs/scripts that can risk causing irreversable damage, unauthorized modifications, or disrupts network services for any programs or devices.</li>
                                ...
                                <p>These rules also apply to official communication services such as forums, mailing lists, irc channels, newsgroups, and any other service hosted on thunix. If you come across anything that violates the terms of service, please let us know with the <a href="/abuse.php">abuse reporting page</a>.</p>
							</div>
						</div>
						<div style="clear: both;">&nbsp;</div>
						</div>
