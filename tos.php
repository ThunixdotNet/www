					...
					<div id="content">
						<div class="post">
							...
							<div class="entry">
								...
								<p>If you want to request for content you own the copyright for to be removed from thunix, please email <a href="mailto:abuse@thunix.cf"><code>&lt;abuse@thunix.cf&gt;</code></a>. In the email, please identify who you are, if you are the copyright holder or legally representing them, the exact files you want removed with links to the files and infringed content, and contact information such as phone numbers or a reply-to email address.</p>
